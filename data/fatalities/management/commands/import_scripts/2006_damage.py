...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        Damage.objects.filter(vehicle__accident__year=2006).delete()
        ...
        for x in csv.index:
            ...
            primary_key = f"2006{st_case}{veh_no}{new_damage_id}"
            
            data_to_save = {"vehicle": vehicle, "id": primary_key}
            impact_1 = area_of_impact_converter(csv['IMPACT1'][x], 2006)
            impact_2 = area_of_impact_converter(csv['IMPACT2'][x], 2006)
