...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        InjuryPerson.objects.filter(injury_accident__state_id=17, injury_accident__dt__year=2018).delete()
        InjuryVehicle.objects.filter(injury_accident__state_id=17, injury_accident__dt__year=2018).delete()
        InjuryAccident.objects.filter(state_id=17, dt__year=2018).delete()


        crashes_path = f"{ILLINOIS_PATH}2018_crash.csv"
        vehicle_path = f"{ILLINOIS_PATH}2018_vehicle.csv"
        person_path = f"{ILLINOIS_PATH}2018_person.csv"
