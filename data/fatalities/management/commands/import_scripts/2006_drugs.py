...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        Drugs.objects.filter(person__accident__year=2006).delete()
        ...
        for x in csv.index:
            ...
            for i in [1,2,3]:
                ...
                primary_key = f"2006{st_case}{veh_no}{per_no}{new_drugs_id}"
                data_to_save = {"id": primary_key, "person": person}
                data_to_save['drug_test_type'] = drug_test_type_converter(csv[drug_test_type_variable_name][x], 2006)
