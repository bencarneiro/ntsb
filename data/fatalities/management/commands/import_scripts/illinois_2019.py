...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        InjuryPerson.objects.filter(injury_accident__state_id=17, injury_accident__dt__year=2019).delete()
        InjuryVehicle.objects.filter(injury_accident__state_id=17, injury_accident__dt__year=2019).delete()
        InjuryAccident.objects.filter(state_id=17, dt__year=2019).delete()


        crashes_path = f"{ILLINOIS_PATH}2019_crash.csv"
        vehicle_path = f"{ILLINOIS_PATH}2019_vehicle.csv"
        person_path = f"{ILLINOIS_PATH}2019_person.csv"
