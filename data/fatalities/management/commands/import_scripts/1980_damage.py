...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        Damage.objects.filter(vehicle__accident__year=1980).delete()
        ...
        for x in csv.index:
            ...
            primary_key = f"1980{st_case}{veh_no}{new_damage_id}"
            
            impact_1 = area_of_impact_converter(csv['IMPACT1'][x], 1980)
            impact_2 = area_of_impact_converter(csv['IMPACT2'][x], 1980)
