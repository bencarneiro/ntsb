...
# 1975 - 2015 cf1, cf2, cf3

class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        CrashRelatedFactors.objects.filter(accident__year=2015).delete()
        ...
        for x in csv.index:
            ...
            for factor in ["CF1", "CF2", "CF3"]:
                ...
                primary_key = f"2015{st_case}{new_factor_id}"
                converted_factor_code = crash_related_factor_converter(csv[factor][x], 2015)
