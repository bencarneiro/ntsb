...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        ...
        csv = pd.read_csv("/home/tonydeals/app/ntsb/data/csvs/2022/FARS2022NationalCSV/maneuver.csv", encoding='latin-1')
        for x in csv.index:
            ...
            primary_key = f"2022{st_case}{veh_no}{new_maneuver_id}"
