...
# before 2017, only one race recorded at person level

class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        Race.objects.filter(person__accident__year=2017).delete()
        ...
        for x in csv.index:
            ...
            primary_key = f"2017{st_case}{veh_no}{per_no}{new_race_id}"
