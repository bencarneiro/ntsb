...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        InjuryPerson.objects.filter(injury_accident__dt__year=2012).delete()
        InjuryVehicle.objects.filter(injury_accident__dt__year=2012).delete()
        InjuryAccident.objects.filter(dt__year=2012).delete()
