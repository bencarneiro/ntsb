...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        Vehicle.objects.filter(accident__year=2024).delete()
        ...
        csv = pd.read_csv(f"{CSV_PATH}2024/FARS2024NationalCSV/vehicle.csv", encoding='latin-1')
        for x in csv.index:
            ...
            for model_field_name in vehicle_model_fields:
                data_source = get_data_source("vehicle." + model_field_name, 2024)
