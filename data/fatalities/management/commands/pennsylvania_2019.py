...
class Command(BaseCommand):
    def handle(self, *args, **kwasrgs):
        InjuryPerson.objects.filter(injury_accident__state_id=42, injury_accident__dt__year=2019).delete()
        InjuryVehicle.objects.filter(injury_accident__state_id=42, injury_accident__dt__year=2019).delete()
        InjuryAccident.objects.filter(state_id=42, dt__year=2019).delete()

        crashes_path = f"{PENNSYLVANIA_PATH}crash_2019.csv"
        roadway_path = f"{PENNSYLVANIA_PATH}roadway_2019.csv"
        vehicle_path = f"{PENNSYLVANIA_PATH}vehicle_2019.csv"
        person_path = f"{PENNSYLVANIA_PATH}person_2019.csv"
