tippecanoe -zg -o ~/apps/ntsb/data/fatalities/templates/static/tiles/texas/texas_injuries.pmtiles --coalesce-densest-as-needed -y id -y fatalities -y serious_injuries -y dt ~/Downloads/texas_injuries.csv
tippecanoe -zg -o ~/apps/ntsb/data/fatalities/templates/static/tiles/texas/texas_fatalities.pmtiles --coalesce-densest-as-needed -y st_case -y fatalities -y serious_injuries -y dt ~/Downloads/texas_fatalities.csv
