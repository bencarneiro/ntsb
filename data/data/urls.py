...
urlpatterns = [
    ...
    path("arizona_injury_csv", arizona_injury_csv, name="arizona_injury_csv"),
    path("arizona_fatality_csv", arizona_fatality_csv, name="arizona_fatality_csv"),
    path("arizona_fatality_csv_2", arizona_fatality_csv_2, name="arizona_fatality_csv_2"),
    path("massachusetts_injury_csv", massachusetts_injury_csv, name="massachusetts_injury_csv"),
    path("massachusetts_fatality_csv", massachusetts_fatality_csv, name="massachusetts_fatality_csv"),
    path("massachusetts_fatality_csv_2", massachusetts_fatality_csv_2, name="massachusetts_fatality_csv_2"),
    path("tennessee_fatality_csv", tennessee_fatality_csv, name="tennessee_fatality_csv"),
    path("tennessee_fatality_csv_2", tennessee_fatality_csv_2, name="tennessee_fatality_csv_2"),
    path("tennessee_injury_csv", tennessee_injury_csv, name="tennessee_injury_csv"),
    ...
    path("arizona", arizona, name="arizona"),
    path("massachusetts", massachusetts, name="massachusetts"),
    path("tennessee", tennessee, name="tennessee"),
